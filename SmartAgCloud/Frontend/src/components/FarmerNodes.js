...
class FarmerNodes extends Component{
    ...
    render(){
        ...
        const farmerNodeItems = this.props.farmer_nodes.map((eachNode)=>{
            return(
                <tr>
...
const matchStateToProps = (state) => ({
    farmer_nodes:state.farmer_nodes,
})

export default connect(matchStateToProps,{fetchFarmerNodes})(FarmerNodes);