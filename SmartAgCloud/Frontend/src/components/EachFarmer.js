                ...
                <div className="dashboard-container container">
                    <div className="row">
                        ...
                        <div className="col-md-11">
                            <form>
                                <label for=""search><h2>Search for Farmers here:</h2></label>
                                <input type="text" className="search-box" onChange={this.onSearchTextChange}/>
                            </form><br/><br/>
                            <div>
                                {farmerItems}
                            </div>
...
export default connect(mapStateToProps, {fetchEachFarmer})(FetchEachFarmer);